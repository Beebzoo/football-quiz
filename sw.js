...
const EXTRA_ASSETS = ["assets/ball.png", "assets/stadiums/index.json", "assets/facts/index.json", "assets/kits/index.json", "assets/kits/_base.png", "assets/nations/index.json",
  "assets/badges/index.json",
  "assets/xi/index.json",
  "assets/timeline/index.json",
  "assets/vendor/supabase.js",
  ...NATFLAGS.map(c => "assets/natflags/" + c + ".png")];
const CAREER_LOGOS = [
