...
const EXTRA_ASSETS = ["assets/ball.png", "assets/stadiums/index.json", "assets/facts/index.json", "assets/deep/index.json", "assets/nicknames/index.json", "assets/awards/index.json", "assets/hilo/index.json", "assets/kits/index.json", "assets/kits/_base.png", "assets/nations/index.json",
  ...
  /* the credits are only read when someone opens them, but they must still be
     readable with no signal: a licence you can only see online is not much of
     an attribution */
  "assets/credits.json",
  ...
  ...[400, 600, 700].flatMap(w => ["latin", "latin-ext"].map(
